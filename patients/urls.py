...
urlpatterns = [
    ...
    # API paths
    path('api/patients/', cache_page(60*60)(views.get_patients),name='patient list'),
    path('api/patient/<int:id>', cache_page(60*60)(views.get_patient),name='patient'),
    path('api/patient/<int:patient_id>/sources', cache_page(60*60)(views.get_sources_for_patient), name='patient-sources'),
]
