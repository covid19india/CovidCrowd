    ...
    <main className="container" style={{ minHeight: '80vh' }}>
      ...
      <div className="row my-2">
        <div className="col p-1">
          <SmallCard icon="bullhorn" title="Announced" content={patient.diagnosed_date} />
        </div>
        <div className="col p-1">
          <SmallCard icon="venus-mars" title="Gender" content={patient.gender} />
        </div>
        <div className="col p-1">
          <SmallCard icon="user-plus" title="Age" content={patient.age} />
        </div>
        <div className="col p-1">
          <SmallCard icon="heartbeat" title="Status" content={patient.current_status} />
        </div>
        <div className="col p-1">
          <SmallCard icon="map-marker-alt" title="State" content={patient.detected_state} />
        </div>
        <div className="col p-1">
          <SmallCard icon="globe-asia" title="Country" content={patient.nationality} />
        </div>
      </div>
      ...
      <div className="row my-2">
        ...
        <div className="col-12 col-md-4 p-1">
          <div className="card mb-2">
            <div className="card-header"><strong>Status Change</strong></div>
